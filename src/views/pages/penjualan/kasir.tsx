              ...
              <div className="flex-1 p-4 flex flex-col">
                <div className="flex-1">
                  <div className="text-center mb-6">
                    <div className="text-4xl font-bold text-gray-800">{formatPrice(parseFloat(paymentAmount) || 0)}</div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6">
                    ...
                    <button
                      onClick={() => handleNumberInput('delete')}
                ...
                <button
                  ...
                  disabled={!customerName || !paymentAmount || getChange() < 0}
